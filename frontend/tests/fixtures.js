...
export const doneInadmissible = {
  ...
  deadline: {
    ...
    detail: '送達生效日114年5月28日，起算日114年5月29日，期間３０日、在途０日，末日114年6月27日，機關收文日114年10月31日，已逾期。',
    review_note: '',
  },
  f2: null,
  f2_refs: f2Refs,
...
export const doneInadmissibleSectioned = {
  ...doneInadmissible,
  case_id: 'c-8',
  draft_plain_text: [
    '主　文',
...
export const collectingAllMatched = {
  ...
  documents: {
    ...
    answer: { slot: 'answer', source: 'text', text: '訴願答辯書全文', check: { matched: true, method: 'rule', note: '符合訴願答辯書的文字特徵' } },
  },
  f1: null,
  screening: null,
  deadline: null,
